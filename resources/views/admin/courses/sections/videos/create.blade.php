   ...
   <nav class="breadcrumb sl-breadcrumb">
    ...
    <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
            ...
            <form action="{{ route('manage.videos.store',$section->id) }}" method="post">
                @csrf
                <div class="row mg-t-20">
                    <div class="col-lg">
                        <label for="name">Title</label>
                        <input class="form-control" placeholder="Video Title" type="text" name="title" value="{{ old('title') }}">
                    </div>
                </div>
                <div class="row mg-t-20">
                    <div class="col-lg">
                ...
                <div class="row mg-t-20">
                    <div class="col-lg text-right" >
                            <button type="submit" class="btn btn-info mt-10 ">Continue</button>
                    </div>
                </div>
            </form>
