...
@section('content')
    ...
    <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40 mb-20">
            <h6 class="card-body-title mg-b-20-force">Table for My-Courses
                    ...
                    <tbody style="background-color: white;">
                        @foreach($courses as $course)
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                            <a href="{{ route('manage.categories.edit',$course->id) }}" class="btn btn-sm btn-warning mg-l-15" id="">Edit</a>



                                                <form method="post" id="delete" class="ml-3" action="{{route('manage.categories.destroy',$course->id)}}">
                                                    @csrf
                                                    @method('DELETE')
