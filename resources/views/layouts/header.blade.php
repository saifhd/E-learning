                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('front.courses.index') }}" class="{{ in_array('courses',$url_array) ? 'active' : '' }}">Courses</a>
                                    <ul class="sub-menu">
                                ...
                                <li class="nav-item">
                                    <a class="{{ in_array('posts',$url_array) ? 'active' : '' }}" href="{{ route('front.posts.index') }}">Blog</a>
                                </li>
                                ...
                                @auth
                                    <li>
                                        ...
                                        <li> <a onclick="document.getElementById('logout').submit();" type="submit" class="btn">Logout</a></li>
                                    </li>
                                @endauth
                                @guest
